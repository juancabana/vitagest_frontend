...
import  './LinkFloat.css';
import { Link } from "react-router-dom";
    
import imgBack from "./../../core/assets/img/icons8-gira-a-la-izquierda-50.png";


class LinkFloat extends Component{
    render(){
        return(
            <div className="linkFloat">
            <Link className="links-social-pages back" to="/">
              <img src={imgBack} alt="" />
            </Link>
            <a
              href="mailto: servicio.al.cliente@vitarrico.com.co"
              target="_blank"
              rel="noopener noreferrer"
              className="links-social-pages link-gmail"
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="links-social-pages link-wassap"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 100 100"
